...
public class ServletForwardA extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // RequestDispatcher requestDispatcher = req.getRequestDispatcher("servletForwardB"); // 可以
        // RequestDispatcher requestDispatcher = req.getRequestDispatcher("forward.html");    // 可以
        // RequestDispatcher requestDispatcher = req.getRequestDispatcher("www.baidu.com");   // 不可以
         ...
         * 7.目标资源可以是 WEB-INF 下受到保护的资源，也可以是 WEB-INF 下的资源的唯一访问方式
         */
